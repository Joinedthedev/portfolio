...
import { SiBootstrap, SiChakraui, SiFirebase, SiJavascript, SiMysql, SiNextdotjs, SiPrisma, SiReact, SiRecoil, SiRedux, SiStripe, SiTailwindcss, SiTypescript, SiVite } from "react-icons/si";
